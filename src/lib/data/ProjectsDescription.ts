...
export const AiProjectDescription:projectDescriptionType  = {
...
export const CryptoCurrencyProjectDescription:projectDescriptionType  = {
...
export const WeatherProjectDescription:projectDescriptionType  = {
...
export const restfulApi:projectDescriptionType  = {
...
`,
	shortDescription: `Discover, RESTful API provides easy access to a rich database of scientific information and learn more by visiting here!`
};